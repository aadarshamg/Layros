...
export default async function ContactPage() {
  ...
  return (
    <div className="content-page page-shell section-pad">
      ...
      <div className="content-contact-card" style={{ display: "grid", gap: 40, gridTemplateColumns: "1fr", maxWidth: 640 }}>
        ...
        <div style={{ display: "grid", gap: 20 }}>
          <div>
            ...
            <a href={`mailto:${email}`} className="button-row" style={{ fontFamily: "var(--font-playfair)", fontSize: 17 }}>
              {email}
            </a>
          </div>
          <div>
            <p className="eyebrow">Phone</p>
            <a href={phoneHref} style={{ fontFamily: "var(--font-playfair)", fontSize: 17 }}>
              {phone}
            </a>
          </div>
          {settings.brandAddress && (
            <div>
              ...
              <p style={{ color: "var(--ink-soft)", whiteSpace: "pre-line" }}>{settings.brandAddress}</p>
            </div>
          )}
          <div>
        ...
        <a href={`mailto:${email}`} className="button button-dark" style={{ width: "fit-content" }}>
          Email client care
        </a>
      </div>
    </div>
